...
- Artifacts prefixed with `ultra-meet-test-`
...
```
ultra-meet-{workflow}-{platform}-{target}-{version}
```

**Examples:**
- `ultra-meet-devtest-macOS-aarch64-apple-darwin-0.1.3`
- `ultra-meet-test-windows-x86_64-pc-windows-msvc-0.1.3`
- `ultra-meet-macos-aarch64-release-0.1.3`
