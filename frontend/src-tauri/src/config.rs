...
pub const WHISPER_MODEL_CATALOG: &[(&str, &str, u32, &str, &str, &str)] = &[
    ...
    ("large-v3-turbo-q8_0", "ggml-large-v3-turbo-q8_0.bin", 874, "High", "Medium", "Top multilingual quality, medium size. 8-bit quantization preserves near-full accuracy."),
    ("distil-large-v3.5", "ggml-model.bin", 1550, "High", "Fast", "Fastest Whisper variant. 1.46× faster than turbo. English speech only — use Large V3 Turbo for multilingual."),
