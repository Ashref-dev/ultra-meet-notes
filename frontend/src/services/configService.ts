...
export class ConfigService {
  ...
  async getSaveLocations(): Promise<SaveLocations> {
    return invoke<SaveLocations>('get_save_locations');
  }
...
export async function testOpenRouterConnection(apiKey: string): Promise<void> {
  return invoke('test_openrouter_connection', { apiKey });
}
