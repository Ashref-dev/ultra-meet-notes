  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-5">
        ...
        >
          <SelectTrigger className="h-11 rounded-xl border-transparent bg-card/70 text-left text-foreground shadow-sm backdrop-blur-sm focus:border-ring focus:ring-1 focus:ring-ring">
            <SelectValue placeholder="Select transcription language" />
          </SelectTrigger>
          <SelectContent className="rounded-xl border-transparent bg-popover/95 shadow-xl backdrop-blur-xl">
        ...
        {isParakeet && (
          <div className="rounded-xl bg-muted/60 p-4 text-foreground shadow-sm backdrop-blur-sm">
            <p className="font-medium">Parakeet Language Support</p>
            <p className="mt-2 text-xs leading-relaxed text-muted-foreground">Parakeet currently only supports automatic language detection. Manual language selection is not available. Use Whisper if you need to specify a particular language.</p>
          </div>
        )}
        ...
        <div className="space-y-3 pt-4 text-xs">
          ...
          {selectedLanguage === 'auto' && (
            <div className="rounded-xl bg-muted/60 p-4 text-foreground shadow-sm backdrop-blur-sm">
              ...
              <p className="mt-2 leading-relaxed text-muted-foreground">For best accuracy, select your specific language (e.g., English, Spanish, etc.)</p>
            </div>
          )}
          {selectedLanguage === 'auto-translate' && (
            <div className="rounded-xl bg-accent/10 p-4 text-foreground shadow-sm backdrop-blur-sm">
              <p className="font-medium">Translation Mode Active</p>
              <p className="mt-2 leading-relaxed text-muted-foreground">All audio will be automatically translated to English. Best for multilingual meetings where you need English output.</p>
            </div>
          )}
