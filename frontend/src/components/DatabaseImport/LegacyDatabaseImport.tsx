  ...
  const handleBrowse = async () => {
    try {
      ...
      if (dbPath) {
        ...
        setErrorMessage('No database found at selected location. Please select the data folder, backend folder, or the database file directly.');
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            <p className="text-sm text-gray-600">
              Select your previous data folder, backend directory, or database file:
            </p>
            ...
            <Button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-[#5B4DCC] to-[#FFD166] px-4 py-3 text-white transition-colors hover:from-[#6A5ACF] hover:to-[#FFE08A] disabled:cursor-not-allowed disabled:bg-gray-400"
            >
