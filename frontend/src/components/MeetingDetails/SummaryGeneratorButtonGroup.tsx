    ...
    <>
      <div className="flex flex-wrap items-center gap-2">
        {isGenerating ? (
          <Button
            variant="destructive"
            className="h-12 min-w-[180px] rounded-lg px-5 text-sm shadow-lg transition-[background-color,color,border-color,transform] duration-200 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background motion-reduce:transition-none motion-safe:active:scale-[0.98]"
            onClick={() => {
              onStopGeneration();
            }}
          ...
          >
            {isCheckingModels || isModelConfigLoading ? 'Processing...' : 'Generate Summary'}
          </GradientPillButton>
        )}
        ...
        <div className="inline-flex items-center gap-1 rounded-xl bg-card/60 p-1 shadow-sm backdrop-blur-sm">
          <Dialog open={settingsDialogOpen} onOpenChange={setSettingsDialogOpen}>
            <DialogTrigger asChild>
              <Button
                variant="secondary"
                className="h-10 rounded-lg bg-transparent px-4 text-sm shadow-none transition-[background-color,color,transform] duration-200 hover:bg-muted/80 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background motion-reduce:transition-none motion-safe:active:scale-[0.98]"
