    ...
    <div className='flex flex-col gap-4'>
      <div className="rounded-xl border border-border bg-card p-6 shadow-sm shadow-black/5">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="mb-2 text-lg font-semibold text-foreground">Auto Summary</h3>
      ...
      <div className="rounded-xl border border-border bg-card p-6 shadow-sm shadow-black/5">
        <h3 className="mb-4 text-lg font-semibold text-foreground">Summary Model Configuration</h3>
