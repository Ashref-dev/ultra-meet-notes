  ...
  const handleMicrophoneAction = async () => {
    if (permissions.microphone === 'denied') {
      ...
      try {
        ...
        toast.info('Please enable microphone access', { description: 'Go to System Preferences > Security & Privacy > Microphone', duration: 8000 });
      }
      return;
    }
  ...
  const handleSystemAudioAction = async () => {
    if (permissions.systemAudio === 'denied') {
      ...
      try {
        ...
        toast.info('Please enable Audio Capture', { description: 'Go to System Settings > Privacy & Security > Audio Capture', duration: 8000 });
      }
      return;
    }
    ...
    <OnboardingContainer
      ...
      description={
        <>
          ...
          <span> needs access to your microphone and system audio to record meetings</span>
        </>
      }
      step={4}
      hideProgress={true}
