...
export const MODEL_CONFIGS: Record<string, Partial<ModelInfo>> = {
  ...
  'large-v3-turbo-q8_0': {
    description: 'Top multilingual quality, medium size. 8-bit quantization preserves near-full accuracy.',
    size_mb: 874,
    accuracy: 'High',
    speed: 'Medium'
  },
  'distil-large-v3.5': {
    description: 'Fastest Whisper variant. 1.46× faster than turbo. English speech only — use Large V3 Turbo for multilingual.',
    size_mb: 1550,
    accuracy: 'High',
    speed: 'Fast'
  },
...
// Helper functions
export function getModelIcon(_accuracy: ModelAccuracy): string {
  return '';
}
