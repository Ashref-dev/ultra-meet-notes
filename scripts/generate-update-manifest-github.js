...
console.log(`GitHub Repository: Ashref-dev/ultra-meet-notes`);
...
bundleFiles.forEach(filename => {
  ...
  if (platform && !platforms[platform]) {
    ...
    const githubUrl = `https://github.com/Ashref-dev/ultra-meet-notes/releases/download/${versionDir}/${filename}`;
...
console.log(`   URL: https://github.com/Ashref-dev/ultra-meet-notes/releases/new?tag=v${versionClean}`);
...
console.log(`   curl https://github.com/Ashref-dev/ultra-meet-notes/releases/latest/download/latest.json`);
